...
MODULE_PATH = Path(os.environ.get(
    "FINALIZER_MODULE",
    "/Users/mac/Documents/agent架构师/教育直播竞品情报Agent/修复交付/2026-08-30-finalizer-evidence/staging/v3_worker_candidate.py",
))
spec = importlib.util.spec_from_file_location("finalizer_module_under_test", MODULE_PATH)
