...
TABLE_ORDER = [
    ...
    "outbox", "delivery_receipts", "dead_letters", "lineage_edges", "recompute_requests", "evidence_bundles",
    "comparisons", "comparison_evidence", "strategy_versions", "version_observations",
    "strategy_candidates", "strategy_evidence", "knowledge_versions", "knowledge_diffs",
    "knowledge_publish_receipts", "review_items",
